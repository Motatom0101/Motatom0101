...
Sou um profissional **autodidata em melhora contínua** apaixonado por tecnologia; desde o começo de 2025 em formação intensiva para me tornar um QA (Quality Assurance) Engineer com a filosofia **Shift Left**. Apesar de começado a publicar meu aprendizado apenas em 2024, comecei a estudar tecnologia bem antes de 2020. Alias, já tinha tentado aprender Linux e redes pela 1ª vez em 2017. Mas, percebi que eu teria que aprender muita coisa antes - eis que entrei pela toca do coelho e não quero sair mais. Antes, de fato, não sabia para onde estava indo. Contudo, hoje tenho certeza do que quero. Meu objetivo é **garantir a qualidade e prevenir defeitos o mais cedo possível** no Software Development Life Cycle **(SDLC)**, trabalhando ativamente com o time, o PO e o Product Backlog em ambientes ágeis (Scrum).
...
[Repositório:]() Este repositório contém a documentação dos meus estudos com testes em APIs com Postman e projeto.
#
...
No meu perfil do "[**Medium**](https://medium.com/@atom.free)", **desde 09/05/2024** mantenho um acervo com **mais de 90 artigos técnicos** que documentam o meu aprendizado e aprofundam todos os temas listados em minhas habilidades. É uma fonte rica, **baseada em cursos e estudos autodidatas, que comprova minha jornada e conhecimento em QA e TI**. Estes são os principais:
