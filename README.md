...
Sou um profissional autodidata e apaixonado por tecnologia, desde o começo de 2025 em formação intensiva para me tornar um QA (Quality Assurance) Engineer com a filosofia **Shift Left**. Apesar de começado a publicar meu aprendizado em 2024, comecei a estudar tecnologia bem antes de 2020. Alias, já tinha tentado aprender Linux pela 1ª vez em 2017. Mas, percebi que eu teria que aprender muita coisa antes; eis que entrei na toca do coelho e não quero sair mais. Antes, realmente não sabia para onde estava indo. Contudo, hoje tenho certeza do que quero. Meu objetivo é **garantir a qualidade e prevenir defeitos o mais cedo possível** no Software Development Life Cycle **(SDLC)**, trabalhando ativamente com o time, o PO e o Product Backlog em ambientes ágeis (Scrum).
